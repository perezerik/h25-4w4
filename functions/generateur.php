...
function creer_vague_avec_gradient($couleur_haut, $couleur_bas) { ?>
    <svg class="vague" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none">
        <defs>
            <linearGradient id="grad1" x1="0%" y1="0%" x2="0%" y2="100%">
                <stop offset="0%" stop-color="<?= $couleur_haut ?>" stop-opacity="1" />
                <stop offset="100%" stop-color="<?= $couleur_bas ?>" stop-opacity="1" />
            </linearGradient>
        </defs>
        <path fill="url(#grad1)" fill-opacity="1">
            <animate attributeName="d" dur="6s" repeatCount="indefinite"
                ...
                M0,64L20,101.3C40,139,80,213,120,250.7C160,288,200,288,240,288C280,288,320,288,360,250.7C400,213,440,139,480,128C520,117,560,171,600,181.3C640,192,680,160,720,154.7C760,149,800,171,840,202.7C880,235,920,277,960,266.7C1000,256,1040,192,1080,170.7C1120,149,1160,171,1200,181.3C1240,192,1280,192,1320,160C1360,128,1400,64,1420,32L1440,0L1440,320L0,320Z;
